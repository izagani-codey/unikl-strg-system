...
<div class="mb-6 border-b border-gray-200 pb-6 min-w-0">
    ...
    <div id="vot-items-container" class="space-y-3 min-w-0">
    ...
    <div class="mt-4 flex justify-between items-center bg-gray-100 p-4 rounded-lg min-w-0">
...
<template id="vot-item-template">
    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 vot-item-row min-w-0">
        ...
        <p class="text-xs text-gray-500 mt-2 vot-desc-preview break-words"></p>
    </div>
</template>
